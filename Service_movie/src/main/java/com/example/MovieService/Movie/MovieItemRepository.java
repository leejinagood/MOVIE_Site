...
public class MovieItemRepository {
    ...
    private static final Map<Long, MovieDTO> store = new HashMap<>(); // Movie 클래스 객체를 HashMap 타입으로 지정
    ...
    public void update(Long itemId, MovieDTO updateItem) {

        MovieDTO findItem = findById(itemId);
